...
public class SetupRes_fr extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup", 	"Configuration du serveur Ompiere" },
	{ "Ok", 					"Ok" },
	{ "File", 					"Fichier" },
	{ "Exit", 					"Sortir" },
	{ "Help", 					"Aide" },
	{ "PleaseCheck", 			"Verifiez" },
	{ "UnableToConnect", 		"Impossible d'obtenir de l'aide depuis le site web Ompiere" },
	//
	{ "AdempiereHomeInfo", 		"R\u00E9pertoire racine d'Ompiere est le repertoire principale" },
	{ "AdempiereHome", 			"R\u00E9pertoire racine d'Ompiere" },
	...
	{ "DatabaseUserInfo", 		"ID de l'utilisateur de la base de donn\u00E9es Ompiere" },
	{ "DatabaseUser", 			"Utilisateur de la base de donn\u00E9es" },
	{ "DatabasePasswordInfo", 	"Mot de passe de la base de donn\u00E9es Ompiere" },
	...
	{ "AdminEMailInfo", 		"Courriel de l'administrateur Ompiere" },
	...
	{ "JNPPort", 				"Port JNP" },
	{ "MailUserInfo", 			"Utilisateur courriel Ompiere" },
	{ "MailUser", 				"Utilisateur courriel" },
	{ "MailPasswordInfo", 		"Mot de passe de l'utilisateur Ompiere" },
	...
	{ "ErrorAdempiereHome", 	"Erreur sur le r\u00E9pertoire Ompiere" },
	{ "ErrorAppsServer", 		"Erreur Serveur Apps" },
	{ "ErrorWebPort", 			"Erreur port Web" },
	{ "ErrorJNPPort", 			"Erreur port JNP" },
	{ "ErrorDatabaseServer", 	"Erreur serveur de base de donn\u00E9es" },
	...
	{ "ErrorMailServer", 		"Erreur serveur de Courriel" },
