...
public class SetupRes_es extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup",	"Configuraci\u00f3n Servidor Ompiere" },
	{ "Ok", 					"Aceptar" },
	{ "File", 					"Archivo" },
	{ "Exit", 					"Salir" },
	{ "Help", 					"Ayuda" },
	{ "PleaseCheck", 			"Por favor compruebe" },
	{ "UnableToConnect",		"No se ha podido obtener ayuda de la web de Ompiere" },
	//
	{ "AdempiereHomeInfo", 		"Ompiere Home es la carpeta principal" },
	...
	{ "DatabaseUserInfo", 		"ID Usuario Base de Datos Ompiere" },
	{ "DatabaseUser", 			"Usuario Base de Datos" },
	{ "DatabasePasswordInfo", 	"Contrase\u00f1a Usuario Base de Datos Ompiere" },
	...
	{ "JNPPort", 				"Puerto JNP" },
	{ "MailUserInfo", 			"Usuario Correo Ompiere" },
	{ "MailUser", 				"Usuario Correo" },
	{ "MailPasswordInfo", 		"Contrase\u00f1a Usuario Correo Ompiere" },
