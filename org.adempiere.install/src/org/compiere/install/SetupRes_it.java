...
public class SetupRes_it extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup",	"Configurazione Server Ompiere" },
	{ "Ok", 					"Ok" },
	{ "File", 					"File" },
	{ "Exit", 					"Uscire" },
	{ "Help", 					"Help" },
	...
	//
	{ "AdempiereHomeInfo", 		"Ompiere Home:variabile di ambiente di Ompiere" },
	{ "AdempiereHome", 			"Ompiere Home" },
	{ "WebPortInfo", 			"Porta Web (HTML): Se esiste Apache server utilizzare la porta 8080 o 8088" },
	{ "WebPort", 				"Porta Web" },
	{ "AppsServerInfo", 		"Application Server: Nome dell'Host sul quale si installa Ompiere" },
	...
	{ "DatabaseUserInfo", 		"Utente del DataBase: Nome di creazione dello schema Ompiere" },
	{ "DatabaseUser", 			"Utente del DataBase" },
	{ "DatabasePasswordInfo", 	"Password del Database: dello schema Ompiere" },
	...
	{ "AdminEMailInfo", 		"Email Amministratore Ompiere" },
	...
	{ "ErrorAdempiereHome", 	"Errore Ompiere Home" },
	{ "ErrorAppsServer", 		"Errore Servidor Aplicaci\u00f3n" },
	{ "ErrorWebPort", 			"Errore Porta Web: potrebbe essere occupata dall'apache server o dal server Ompiere utilizzare 8080" },
	{ "ErrorJNPPort", 			"Errore Porta JNP potrebbe essere occupata da un'altra istanza del server Ompiere" },
	{ "ErrorDatabaseServer",	"Errore Server DataBase" },
	{ "ErrorDatabasePort", 		"Errore Porta DataBase" },
	{ "ErrorJDBC", 				"Errore connessione JDBC" },
	{ "ErrorTNS", 				"Errore Connessione al TNS" },
	{ "ErrorMailServer", 		"Errore Connessione server Posta: Deve essere un server che risponde a chiamate SMTP sulla porta 25" },
