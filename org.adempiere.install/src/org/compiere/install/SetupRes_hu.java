...
public class SetupRes_hu extends ListResourceBundle
{
	...
	{ "AdempiereServerSetup", 	"Ompiere Szerver Beállítása" },
	{ "Ok", 					"Ok" },
	{ "File", 					"Fájl" },
	{ "Exit", 					"Kilépés" },
	{ "Help", 					"Súgó" },
	{ "PleaseCheck", 			"Kérem ellenőrizze" },
	{ "UnableToConnect", 		"Nem sikerült elérni a súgót az Ompiere web oldalán" },
	//
	{ "AdempiereHomeInfo", 		"Ompiere Home is the main Folder" },
	...
	{ "DatabaseUserInfo", 		"Database Ompiere User ID" },
	{ "DatabaseUser", 			"Database User" },
	{ "DatabasePasswordInfo", 	"Database Ompiere User Password" },
	...
	{ "AdminEMailInfo", 		"Ompiere Administrator EMail" },
	...
	{ "JNPPort", 				"JNP Port" },
	{ "MailUserInfo", 			"Ompiere Mail User" },
	{ "MailUser", 				"Mail User" },
