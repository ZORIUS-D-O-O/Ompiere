...
public class SetupRes_my extends ListResourceBundle
{
	...
	{ "UnableToConnect",	"Tidak mendapat bantuan dari laman projek Ompiere" },

	{ "AdempiereHomeInfo", 	"Ompiere Home adalah folder utama" },
	{ "AdempiereHome", 		"Ompiere Home" },
	{ "WebPortInfo", 		"Web (HTML) Port" },
	{ "WebPort", 			"Web Port" },
	{ "AppsServerInfo", 	"Nama Pelayan Ompiere" },
	...
	{ "DatabaseUserInfo", 	"Database Ompiere ID Pengguna Database Ompiere" },
	...
	{ "AdminEMailInfo", 	"Emel Pentadbiran Ompiere" },
	...
	{ "JNPPort", 			"JNP Port" },
	{ "MailUserInfo", 		"Pengguna Emel Ompiere" },
	{ "MailUser", 			"Pengguna Emel" },
	{ "MailPasswordInfo", 	"Kata-Laluan Pengguna Emel Ompiere" },
