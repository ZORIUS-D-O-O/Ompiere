...
public final class Adempiere
{
	...
	/** URL of Product          */
	static public final String	URL				= "ompiere.org";
	/** 16*16 Product Image. **/
	...
	static public final String	COPYRIGHT		= "\u00A9 2025-2025 Ompiere\u00AE";
	...
	private static void setPackageInfo()
	{
		...
		if (s_ImplementationVendor == null)
		{
			s_ImplementationVendor = "Based on iDempiere, supported by Zorius d.o.o.";
